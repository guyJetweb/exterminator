 ...
 * @package Genesis\Widgets
 */
class Jetweb_Featured_Service extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array(
            'classname' => 'featured-content featuredservice',
            'description' => __('Displays featured page with thumbnails', 'genesis'),
        );

        $control_ops = array(
            'id_base' => 'featured-service',
            'width' => 200,
            'height' => 250,
        );

        parent::__construct('featured-service', 'Jetweb - Featured Service', $widget_ops, $control_ops);
    }
